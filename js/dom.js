...
const leftMuteBtn = $('#leftMuteBtn');
const rightMuteBtn = $('#rightMuteBtn');
const fps = $('#fps');
...
const hlThrInput = $('#hlThr');
const hlThrValEl = $('#hlThrVal');
const hlThrResetBtn = $('#hlThrResetBtn');
const highlightContainer = $('#highlightContainer');
const highlightCanvas = $('#highlightCanvas');
const highlightPh = $('#highlightPh');
