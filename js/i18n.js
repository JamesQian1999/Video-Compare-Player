...
const I18N = {
  zh: {
    ...
    'btn.mute.title': '總靜音 (M)',
    'label.masterVol.title': '總音量',
    'audio.left': '左',
    'audio.right': '右',
    'label.leftVol.title': '左側音量',
    'label.rightVol.title': '右側音量',
    'btn.muteLeft.title': '左側靜音',
    'btn.muteRight.title': '右側靜音',
  ...
  en: {
    ...
    'btn.mute.title': 'Master mute (M)',
    'label.masterVol.title': 'Master volume',
    'audio.left': 'L',
    'audio.right': 'R',
    'label.leftVol.title': 'Left volume',
    'label.rightVol.title': 'Right volume',
    'btn.muteLeft.title': 'Mute left',
    'btn.muteRight.title': 'Mute right',
